...
<head>
	...
	<!-- set the page title -->
	<title>Edit {{$sweeper->title}} Information</title>
                  ...
                  <section id="content" class="container pEqual">
                    <div class="addProperty">
                      ...
                      <div class="formContent">
						<form method="POST" action="/editInternetInformation/{{$sweeper->id}}">
                            {{ csrf_field() }}
							{{ method_field('PUT') }}
                          ...
                          <div class="row">
                            <div class="col-xs-12">
                              <div class="form-group">
                                ...
                                <input required name="name" type="text" class="form-control" placeholder="{{$sweeper->name}}" id="itemN-15">
                              </div>
                            </div>
							<div class="col-xs-12">
								<div class="form-group">
								  ...
								  <select  required name="address" data-placeholder="" class="form-control" id="itemN-101">
									  <option value="{{$sweeper->address}}">{{$sweeper->address}}</option>
									</select>
								</div>
							  </div>
							  <div  class="col-xs-12 col-sm-6">
								<div class="form-group">
								  ...
								  <select  required name="city_id" data-placeholder="" class="form-control" id="itemN-102">
									  <option value="{{$sweeper->city_id}}">{{$sweeper->city_id}}</option>
									</select>
								</div>
							  </div>
							  <div  class="col-xs-12 col-sm-6">
								<div class="form-group">
								  ...
								  <select  required name="sub_area" data-placeholder="" class="form-control" id="itemN-103">
									  <option value="{{$sweeper->sub_area_id}}">{{$sweeper->sub_area_id}}</option>
									</select>
								</div>
							  </div>
							  <div class="col-xs-12">
                                <div class="form-group">
                                  ...
                                  <input required name="number" type="text" class="form-control" placeholder="{{$sweeper->phone_number}}" id="itemN-36">
                                </div>
                              </div>
							  <div class="col-xs-12">
                                <div class="form-group">
                                  <label for="itemN-32">Description</label>
                                  <input required name="desctiption" type="text" class="form-control" placeholder="{{$sweeper->description}}" id="itemN-32">
                                </div>
							  </div>
