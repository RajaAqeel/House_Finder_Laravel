					...
					<section class="container">
						...
						<header class="contentFiltersHeadingWrap row">
							<div class="col-xs-12 col col-sm-8">
								<h1 class="fontNeuron">{{$internet->title}} <a href="#"
								...
								<address class="captionAddress">
									...
									<p>{{$internet->address}} {{$sub_area_name->name}} {{$city_name->name}}</p>
								</address>
							</div>
							<div class="col-xs-12 col-sm-4 justify-end">
								...
								<strong class="elemenBlock fwNormal fontNeuron subtitle w100">{{$internet->phone_number}}</strong>
							</div>
						</header>
					</section>
					<!-- twoColumns -->
							...
							<div class="col-xs-12 col-sm-12 col-md-8">
								...
								<article id="content">
											...
											<div id="tab1-0">
												<div class="slick-carousel slickSlider postColumnImageSlider">
														<div>
															<div class="imgHolder">
																<a href="#">
																	<img src="../images/internet.jpg" alt="image description">
																</a>
															</div>
														</div>
												</div>
									...
									<section class="accountData">
										<div class="head">
											<h4 class="fontNeuron">Complaint Helpline</h4>
										</div>
										<p>{{$internet->complaint_helpline}}</p>

										<div class="head">
											<h4 class="fontNeuron">Customer Helpline</h4>
										</div>
										<p>{{$internet->customer_service_helpline}}</p>
									</section>
									<section id="address" class="accountData address">
										...
										<div class="listpanel-content widthauto address paddingzero">
											<ul>
												<li><span>Address</span><span class="righttext">: {{$internet->address}},
										...
										<form method="POST" accept="/verifyInternet" class="widgetCalcForm">
											...
											<div class="form-group">
												<textarea required name="message" class="form-control"
													placeholder="">Hello, I hope you will be in your good health. I am agreed with ur payment for verifying my property. So i would like to verify my property with property id {{$internet->id}}. Thanks</textarea>
											</div>
											<button type="submit"
