...
<head>
	...
	<!-- set the page title -->
	<title>Edit {{$housemaid->title}} Information</title>
                  ...
                  <section id="content" class="container pEqual">
                    <div class="addProperty">
                      ...
                      <div class="formContent">
						<form method="POST" action="/editInternetInformation/{{$housemaid->id}}">
                            {{ csrf_field() }}
							{{ method_field('PUT') }}
                          ...
                          <div class="row">
                            <div class="col-xs-12">
                              <div class="form-group">
                                <label for="itemN-15">Housemaid Name*</label>
                                <input required name="name" type="text" class="form-control" placeholder="{{$housemaid->housemaid_name}}" id="itemN-15">
                              </div>
                            </div>
							<div class="col-xs-12">
								<div class="form-group">
								  ...
								  <select  required name="address" data-placeholder="" class="form-control" id="itemN-101">
									  <option value="{{$housemaid->address}}">{{$housemaid->address}}</option>
									</select>
								</div>
							  </div>
							  <div  class="col-xs-12 col-sm-6">
								<div class="form-group">
								  ...
								  <select  required name="city_id" data-placeholder="" class="form-control" id="itemN-102">
									  <option value="{{$housemaid->city_id}}">{{$housemaid->city_id}}</option>
									</select>
								</div>
							  </div>
							  <div  class="col-xs-12 col-sm-6">
								<div class="form-group">
								  ...
								  <select  required name="sub_area" data-placeholder="" class="form-control" id="itemN-103">
									  <option value="{{$housemaid->sub_area_id}}">{{$housemaid->sub_area_id}}</option>
									</select>
								</div>
							  </div>
							  <div class="col-xs-12">
                                <div class="form-group">
                                  ...
                                  <input required name="number" type="text" class="form-control" placeholder="{{$housemaid->phone_number}}" id="itemN-36">
                                </div>
                              </div>
							  <div class="col-xs-12">
                                <div class="form-group">
                                  <label for="itemN-32">Description</label>
                                  <textarea required name="description" type="text" class="form-control" placeholder="{{$housemaid->description}}" id="itemN-32">
                                </div>
							  </div>
