                    ...
                    <div class="addProperty">
                      ...
                      <div class="formContent">
                        <form>
                            ...
                            <div class="col-xs-12">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <button type="button" class="btn btnSecondary buttonL fontNeuron">Find On Map</button>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="btnArea">
                            <a href="add-house-02.html" class="btn btn-lighter"><i class="fi flaticon-arrows-1"></i> Back</a>
                            <a href="add-house-04.html" class="btn btnDark">Next <i class="fi flaticon-arrows"></i></a>
                          </div>
                        </form>
                      </div>
                    </div>
