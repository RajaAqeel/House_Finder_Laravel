					...
					<section class="container">
						...
						<header class="contentFiltersHeadingWrap row">
							<div class="col-xs-12 col col-sm-8">
								<h1 class="fontNeuron">{{$watchman->title}} <a href="#"
							...
							<div class="col-xs-12 col-sm-4 justify-end">
								...
								<strong class="elemenBlock fwNormal fontNeuron subtitle w100">{{$watchman->phone_number}}</strong>
							</div>
						</header>
					</section>
					<!-- twoColumns -->
										...
										<form method="POST" accept="/verifyInternet" class="widgetCalcForm">
											...
											<div class="form-group">
												<textarea required name="message" class="form-control"
													placeholder="">Hello, I hope you will be in your good health. I am agreed with ur payment for verifying my property. So i would like to verify my watchman service with service id {{$watchman->id}}. Thanks</textarea>
											</div>
											<button type="submit"
