                                ...
                                <div class="accountHolder">
                                  ...
                                  <div class="accountContent">
                                    <div class="form-group">
                                      ...
                                      <input required name="name" type="text" class="form-control" placeholder="Ali Tufan" id="itemN-1">
                                    </div>
                                    <div class="form-group">
                                      <label for="itemN-2">Email</label>
                                      <input required name="email" type="email" class="form-control" placeholder="polygontheme@gmail.com" id="itemN-2">
                                    </div>
                                    <div class="form-group">
									...
									<div class="form-group">
										...
										<input required name="cnic" type="tel" class="form-control" placeholder="0000000000000" id="itemN-4">
									  </div>
                                    <div class="form-group">
                                      <label for="itemN-5">Biography</label>
                                      <textarea required name="bio" id="itemN-5" class="form-control" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras et dui vestibulum, bibendum purus sit amet, vulputate mauris. Ut adipiscing gravida tincidunt. Duis euismod placerat rhoncus.Phasellus mollis imperdiet placerat"></textarea>
                                    </div>
