                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-12">
                              <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control" placeholder="Name" id="itemN-15">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                              <div class="form-group">
                            ...
                            <div class="col-xs-12">
                              ...
                              <label for="itemN-22">Description</label>
                                <textarea name="description" class="form-control" id="itemN-22" placeholder="Service Description.."></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="btnArea">
