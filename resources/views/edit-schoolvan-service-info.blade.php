...
<head>
	...
	<!-- set the page title -->
	<title>Edit {{$schoolvan->title}} Information</title>
                  ...
                  <section id="content" class="container pEqual">
                    <div class="addProperty">
                      ...
                      <div class="formContent">
						<form method="POST" action="/editInternetInformation/{{$schoolvan->id}}">
                            {{ csrf_field() }}
							{{ method_field('PUT') }}
                          ...
                          <div class="row">
                            <div class="col-xs-12">
                              <div class="form-group">
                                ...
                                <input required name="service_title" type="text" class="form-control" placeholder="{{$schoolvan->title}}" id="itemN-15">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                              <div class="form-group">
                                <label for="itemN-16">Driver Name</label>
                                <input required name="name" type="text" class="form-control" placeholder="{{$schoolvan->driver_name}}" id="itemN-16">
                              </div>
							</div>
							  <div  class="col-xs-12 col-sm-6">
								<div class="form-group">
								  ...
								  <select  required name="city_id" data-placeholder="" class="form-control" id="itemN-102">
									  <option value="{{$schoolvan->city_id}}">{{$schoolvan->city_id}}</option>
									</select>
								</div>
							  </div>
							  <div  class="col-xs-12 col-sm-6">
								<div class="form-group">
								  ...
								  <select  required name="sub_area" data-placeholder="" class="form-control" id="itemN-103">
									  <option value="{{$schoolvan->sub_area_id}}">{{$schoolvan->sub_area_id}}</option>
									</select>
								</div>
							  </div>
							  <div class="col-xs-12">
                                <div class="form-group">
                                  ...
                                  <input required min="0" name="number" type="text" class="form-control" placeholder="{{$schoolvan->phone_number}}" id="itemN-36">
                                </div>
                              </div>
							  <div class="col-xs-12">
                                <div class="form-group">
                                  <label for="itemN-32">Description</label>
                                  <textarea required name="description" type="text" class="form-control" placeholder="{{$schoolvan->description}}" id="itemN-32">
                                </div>
							  </div>
