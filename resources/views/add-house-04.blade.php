                      ...
                      <div class="formContent">
                        ...
                        <form>
                          ...
                          <ul class="list-unstyled checkList text-primary">
                            <li>
                              <label class="fwNormal customLabelCheck">
                                <input type="checkbox" class="customFormInputReset">
                                <span class="fakeCheckbox"></span>
                                <span class="fakeLabel">Car Parking</span>
                              </label>
                            </li>
                            <li>
                              <label class="fwNormal customLabelCheck">
                            ...
                            <li>
                              <label class="fwNormal customLabelCheck">
                                <input type="checkbox" class="customFormInputReset">
                                <span class="fakeCheckbox"></span>
                                <span class="fakeLabel">Internet Providers</span>
                              </label>
                            </li>
                            <li>
                              <label class="fwNormal customLabelCheck">
                                <input type="checkbox" class="customFormInputReset">
                                <span class="fakeCheckbox"></span>
                                <span class="fakeLabel">Cable Providers</span>
                              </label>
                            </li>
                            <li>
                              <label class="fwNormal customLabelCheck">
                            ...
                            <li>
                              <label class="fwNormal customLabelCheck">
                                <input type="checkbox" class="customFormInputReset">
                                <span class="fakeCheckbox"></span>
                                <span class="fakeLabel">Sweepers</span>
                              </label>
                            </li>
                            <li>
                              <label class="fwNormal customLabelCheck">
                          ...
                          <div class="btnArea">
                            ...
                            <a href="add-house-05.html" class="btn btnDark">Next <i class="fi flaticon-arrows"></i></a>
                          </div>
                        </form>
                      </div>
                    </div>
