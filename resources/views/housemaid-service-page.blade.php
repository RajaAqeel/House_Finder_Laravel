					...
					<section class="container">
						...
						<header class="contentFiltersHeadingWrap row">
							<div class="col-xs-12 col col-sm-8">
								<h1 class="fontNeuron">{{$housemaid->housemaid_name}} <a href="#"
										class="btn btnSmall btn-success fontBase">{{$housemaid->status}}</a></h1>
								<!-- captionAddress -->
								<address class="captionAddress">
									<span class="icn"><i class="fi flaticon-pin-1"></i></span>
									<p>{{$housemaid->address}} {{$sub_area_name->name}} {{$city_name->name}}</p>
								</address>
							</div>
							<div class="col-xs-12 col-sm-4 justify-end">
								...
								<strong class="elemenBlock fwNormal fontNeuron subtitle w100">{{$housemaid->phone_number}}</strong>
							</div>
						</header>
					</section>
					<!-- twoColumns -->
								...
								<article id="content">
											...
											<div id="tab1-0">
												<div class="slick-carousel slickSlider postColumnImageSlider">
														<div>
															<div class="imgHolder">
																<a href="#">
																	<img src="../images/housemaid.png" alt="image description">
																</a>
															</div>
														</div>
												</div>
									...
									<section id="address" class="accountData address">
										...
										<div class="listpanel-content widthauto address paddingzero">
											<ul>
												<li><span>Address</span><span class="righttext">: {{$housemaid->address}},
							...
							<div class="col-xs-12 col-sm-12 col-md-4">
								<aside id="sidebar">
									...
									<section class="contactFormPage widget">
										...
										<form method="POST" accept="/verifyHousemaid" class="widgetCalcForm">
											<div class="row">
												<div class="col-xs-12">
											...
											<div class="form-group">
												<textarea required name="message" class="form-control"
													placeholder="">Hello, I hope you will be in your good health. I am agreed with ur payment for verifying my property. So i would like to verify my property with property id {{$housemaid->id}}. Thanks</textarea>
											</div>
											<button type="submit"
