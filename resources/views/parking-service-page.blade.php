					...
					<section class="container">
						...
						<header class="contentFiltersHeadingWrap row">
							<div class="col-xs-12 col col-sm-8">
								<h1 class="fontNeuron">{{$parking->title}} <a href="#"
										class="btn btnSmall btn-success fontBase">{{$parking->status}}</a></h1>
								<!-- captionAddress -->
								<address class="captionAddress">
									<span class="icn"><i class="fi flaticon-pin-1"></i></span>
									<p>{{$parking->address}} {{$sub_area_name->name}} {{$city_name->name}}</p>
								</address>
							</div>
							<div class="col-xs-12 col-sm-4 justify-end">
								...
								<strong class="elemenBlock fwNormal fontNeuron subtitle w100">{{$parking->area_value}} /
									{{$parking->area_unit}}</strong>
							</div>
						</header>
					</section>
					<!-- twoColumns -->
								...
								<article id="content">
									...
									<section id="Detail" class="accountData">
										...
										<ul class="listpanel-head">
											<li>Phone Number<span>{{$parking->phone_number}}</span></li>
										</ul>
										<div class="listpanel-content">
											<ul>
												<li><span>Parking ID</span><span class="righttext">:
														{{$parking->id}}</span></li>
												<li><span>Parking Size</span><span class="righttext">:
														{{$parking->area_value}} {{$parking->area_unit}}</span></li>
											</ul>
										</div>
									</section>
									...
									<section id="address" class="accountData address">
										<div class="head">
											...
											<div class="btnArea">
												<a href="#" class="btn btn-info"><i class="fi flaticon-pin-1"></i>Open
													on Google Maps</a>
											</div>
										</div>
										<div class="listpanel-content widthauto address paddingzero">
											<ul>
												<li><span>Address</span><span class="righttext">: {{$parking->address}},
							...
							<div class="col-xs-12 col-sm-12 col-md-4">
								<aside id="sidebar">
									...
									<section class="contactFormPage widget">
										...
										<form method="POST" accept="/verifyParking" class="widgetCalcForm">
											<div class="row">
												<div class="col-xs-12">
											...
											<div class="form-group">
												<textarea required name="message" class="form-control"
													placeholder="">Hello, I hope you will be in your good health. I am agreed with ur payment for verifying my property. So i would like to verify my property with property id {{$parking->id}}. Thanks</textarea>
											</div>
											<button type="submit"
